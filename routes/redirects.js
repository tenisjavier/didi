...
const redirectsInit = async (graphql, createRedirect) => {
  createRedirect({
    fromPath: `/mx/food/privacidad/`,
    toPath: `/mx/legal/`,
    isPermanent: true,
  });
  createRedirect({
    fromPath: `/co/food/privacidad/`,
    toPath: `/co/legal/`,
    isPermanent: true,
  });
  createRedirect({
    fromPath: `/pe/food/privacidad/`,
    toPath: `/pe/legal/`,
    isPermanent: true,
  });
  createRedirect({
    fromPath: `/cr/food/privacidad/`,
    toPath: `/cr/legal/`,
    isPermanent: true,
  });
  createRedirect({
    fromPath: `/mx/food/terminos-y-condiciones/`,
    toPath: `/mx/legal/`,
    isPermanent: true,
  });
  createRedirect({
    fromPath: `/co/food/terminos-y-condiciones/`,
    toPath: `/co/legal/`,
    isPermanent: true,
  });
  createRedirect({
    fromPath: `/cr/food/terminos-y-condiciones/`,
    toPath: `/cr/legal/`,
    isPermanent: true,
  });
  createRedirect({
    fromPath: `/pe/food/terminos-y-condiciones/`,
    toPath: `/pe/legal/`,
    isPermanent: true,
  });
  createRedirect({
    fromPath: `/mx/food/restaurantes/promociones-y-campanas/`,
    toPath: `/mx/food/restaurantes/`,
    isPermanent: true,
  });
  createRedirect({
    fromPath: `/co/food/restaurantes/promociones-y-campanas/`,
    toPath: `/co/food/restaurantes/`,
    isPermanent: true,
  });
  createRedirect({
    fromPath: `/cr/food/restaurantes/promociones-y-campanas/`,
