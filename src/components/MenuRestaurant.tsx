...
import { getMenuLinksRestaurant } from '../config/menu-restaurant-config'
...
const Menu = () => {
  ...
  const menuLinksRestaurant: SingleMenuItem[] = getMenuLinksRestaurant(countryCode);
    ...
    <div className="flex h-full items-center ">
      ...
      >
        <ul className="m-0 flex flex-col items-center border-x-0 border-b-0  border-t border-solid border-orange-primary bg-gray-primary bg-opacity-80 lg:h-full lg:flex-row lg:border-0 lg:bg-transparent lg:p-0">
            <>
              {menuLinksRestaurant &&
                menuLinksRestaurant.map((menuLink, index) => (
