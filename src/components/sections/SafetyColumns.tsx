...
const SafetyColumns = ({ images, icons }: SafetyColumnsProps) => {
  const props: ColumnsSectionProps = {
    bgColor: t("SafetyColumns.bgColor"),
    textColor: t("SafetyColumns.textColor"),
    columns: t("SafetyColumns.columns", { returnObjects: true }),
  };
  if (images) {
