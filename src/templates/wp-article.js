...
//           <Link
//             to={returnCountry}
//             className="hover:opacity-80 hover:text-sky-500"
//           >
//             {" "}
...
//         </p>
//         <h1 className="text-orange-primary text-3xl text-bold text-left lg:text-5xl text-center">
//           {title}
//         </h1>
...
//           image={image}
//           alt="jeivi"
//           className="lg:float-left lg:mr-4 lg:h-auto float-none h-80"
//         />
